...
export const Route = createFileRoute("/$lang/about")({
  head: ({ params }) => ({
    meta: [
      { title: params.lang === "ar" ? "عن عيادة شفا الطبية — مهمتنا وفريقنا في عمّان" : "About Shafa Care Clinic — Our Mission, Values & Team in Amman" },
      {
        name: "description",
        content: params.lang === "ar"
          ? "تعرّف على عيادة شفا الطبية في عمّان — مهمتنا وقيمنا في الرحمة والتميز، وفريقنا الطبي بقيادة الدكتور فراس عجو."
      ...
      {
        property: "og:title",
        content: params.lang === "ar" ? "عن عيادة شفا الطبية" : "About Shafa Care Clinic — Our Mission, Values & Team",
      },
      {
        property: "og:description",
        content: params.lang === "ar"
          ? "عيادة شفا الطبية في عمّان: رعاية صحية بقيادة الدكتور فراس عجو. اكتشف مهمتنا وقيمنا."
          : "Shafa Care Clinic in Amman: compassionate care led by Dr. Firas Ajo. Discover our mission and values.",
      },
      { property: "og:url", content: `${site.url}/${params.lang}/about` },
      { name: "twitter:title", content: params.lang === "ar" ? "عن عيادة شفا الطبية" : "About Shafa Care Clinic" },
      {
        name: "twitter:description",
        content: params.lang === "ar"
          ? "مهمتنا وقيمنا وفريقنا الطبي في عيادة شفا"
          : "Shafa Care Clinic in Amman: compassionate care led by Dr. Firas Ajo.",
      },
    ],
    links: [
      { rel: "canonical", href: `${site.url}/${params.lang}/about` },
      { rel: "alternate", hrefLang: "x-default", href: `${site.url}/en/about` },
      { rel: "alternate", hrefLang: "en", href: `${site.url}/en/about` },
      { rel: "alternate", hrefLang: "ar", href: `${site.url}/ar/about` },
    ],
  }),
  component: AboutPage,
});
