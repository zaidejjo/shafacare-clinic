...
export const Route = createFileRoute("/$lang/")({
  head: ({ params }) => ({
    meta: [
      { title: params.lang === "ar" ? "عيادة شفا الطبية — رعاية صحية عائلية في عمّان" : "Shafa Care Clinic — Compassionate Family Healthcare in Amman, Jordan" },
      {
        name: "description",
        content: params.lang === "ar"
          ? "عيادة شفا الطبية تقدّم خدمات الطب العام وطب الأطفال وطب الأسنان وأمراض القلب في عمّان. احجز موعدك اليوم — رعاية صحية شاملة لعائلتك."
      ...
      { property: "og:title", content: params.lang === "ar" ? "عيادة شفا الطبية — رعاية صحية عائلية في عمّان" : "Shafa Care Clinic — Compassionate Family Healthcare in Amman" },
      {
        property: "og:description",
        content: params.lang === "ar"
          ? "طب عام، أطفال، أسنان، قلب، مختبر. عيادة شفا في عمّان — رعاية صحية شاملة لعائلتك."
      ...
      { name: "twitter:title", content: params.lang === "ar" ? "عيادة شفا الطبية" : "Shafa Care Clinic — Compassionate Family Healthcare" },
      {
        name: "twitter:description",
        content: params.lang === "ar"
          ? "رعاية صحية شاملة لعائلتك في عمّان"
          : "Expert family medicine, pediatrics, dental care, cardiology, and wellness services in Amman, Jordan.",
      },
    ],
    links: [
      { rel: "canonical", href: `${site.url}/${params.lang}` },
