...
const desc =
  "Shafa Care Clinic provides wellness and vaccination services in Amman — immunizations, nutrition guidance, and preventive care plans for all ages.";
const ogDesc = "Immunizations, nutrition guidance, and preventive wellness plans in Amman at Shafa Care Clinic.";

export const Route = createFileRoute("/services/wellness-vaccines")({
  head: () => ({
    meta: [
      { title: "Wellness & Vaccines in Amman — Shafa Care Clinic" },
      { name: "description", content: desc },
      { name: "robots", content: "index, follow" },
      { property: "og:title", content: "Wellness & Vaccines — Shafa Care Clinic Amman" },
      { property: "og:description", content: ogDesc },
      { property: "og:url", content: `${site.url}/services/${slug}` },
      { name: "twitter:title", content: "Wellness & Vaccines — Shafa Care Clinic Amman" },
      ...
      <section className="mx-auto max-w-4xl px-6 py-16">
        <div className="rounded-3xl border border-border/60 bg-card p-8 md:p-12">
          ...
          <p className="mt-4 text-muted-foreground leading-relaxed">
            Staying healthy starts with prevention. Our wellness and vaccination department provides
            comprehensive immunizations for children and adults, nutritional counseling, and personalized
            wellness plans to help you stay ahead of health issues. We follow the latest guidelines to
            ensure you and your family receive the most effective preventive care.
          </p>
          <h3 className="mt-8 text-xl font-semibold">What We Offer</h3>
          <ul className="mt-4 space-y-2 text-muted-foreground">
            <li className="flex items-start gap-2">• Routine immunizations (children & adults)</li>
            <li className="flex items-start gap-2">• Seasonal flu & travel vaccines</li>
            <li className="flex items-start gap-2">• Nutritional counseling & weight management</li>
            <li className="flex items-start gap-2">• Preventive health screenings</li>
            <li className="flex items-start gap-2">• Wellness plans & lifestyle coaching</li>
            <li className="flex items-start gap-2">• School & travel health certificates</li>
          </ul>
        </div>
